    ...
    <>
      <GridItem className="mb-4 laptop:mb-0 col-start-1 col-end-5 tablet:col-end-13 laptop:col-end-7 desktop:col-end-13">
        <motion.div
          ...
          className="w-full"
        >
          <h1 className="font-bold text-2xl md:text-3xl py-2 text-primary border-b-2 border-elements">
            About
          </h1>
      ...
      <GridItem className="col-start-1 col-end-5 tablet:col-end-13 laptop:col-start-9 laptop:col-end-13 desktop:col-start-17 desktop:col-end-25">
        <motion.div
          ...
          className="w-full"
        >
          <h1 className="font-bold text-2xl py-2 md:text-3xl border-b-2 border-elements text-primary">
            Tech specs
          </h1>
          {Object.entries({
            Screen: screen,
