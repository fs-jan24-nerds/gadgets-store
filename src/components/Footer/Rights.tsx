export const Rights = () => {
  const people = [
    ...
    { id: 3, name: 'Bohdan Mykhailevskyi', position: 'Full-stack developer', location: 'Lviv' },
    { id: 4, name: 'Oleksandr Yepik', position: 'Full-stack developer', location: 'Kyiv' },
    { id: 5, name: 'Ruslan Chyrkov', position: 'Full-stack developer', location: ' Kharkiv' },
    { id: 6, name: 'Mykyta Donskoy', position: 'Full-stack developer', location: 'Kyiv' },
  ];

  return (
    <div className="container mx-auto mt-10">
      <h1 className="text-3xl font-bold mb-4 text-textMain">Developed by</h1>
